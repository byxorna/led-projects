...
void setup() {
  ...
  FastLED.addLeds<LED_TYPE, LEDS_PIN_2>(masterOutput, NUM_LEDS);
  FastLED.addLeds<LED_TYPE, LEDS_PIN_3>(masterOutput, NUM_LEDS);
  FastLED.addLeds<LED_TYPE, LEDS_PIN_4>(masterOutput, NUM_LEDS);
